<?php
class AjouterTypeRemarque extends Zend_Form
{
	...
	public function init(){
		...
		$EService = new Zend_Form_Element_Text('remarque');
		$ESubmit = new Zend_Form_Element_Submit('ajouter');
		
		$EService->addValidator(new Zend_Validate_Db_NoRecordExists('type_remarque', 'libelle_type_remarque'));
