...
--
-- Client: localhost
-- Généré le : Mer 30 Janvier 2013 à 13:53
...
('CDG', 11, '2013-01-29 18:23:56'),
('CDG', 11, '2013-01-30 23:00:00');
...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  `telephone` int(10) DEFAULT NULL,
  `date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `id_user_pilote` int(11) DEFAULT NULL,
  PRIMARY KEY (`login`,`id_user`),
  KEY `code_ville` (`code_ville`),
...
INSERT INTO `utilisateur` (`id_user`, `login`, `id_service`, `nom`, `prenom`, `email`, `password`, `code_ville`, `adresse`, `telephone`, `date`, `id_user_pilote`) VALUES
(1, 'Annette', 2, 'Duhamel', 'Annette', 'annette.duhamel@gmail.com', 'a21810a01d3fe0df4291d7d3e7abbd1c', '2', '156 Rue du Général de Gaulle', 125659748, '2012-10-22 20:42:55', NULL),
(2, 'Blanche', 4, 'François', 'Blanche', 'blanche.francois@gmail.com', '9599a092e9511944f02a80ea727bb4d5', '3', '24 place rouge', 415623514, '2012-10-22 20:42:55', NULL),
...
(9, 'Daniel', 8, 'Jupon', 'Daniel', 'daniel.jupon@gmail.com', 'aa47f8215c6f30a0dcdb2a36a9f4168e', '6', '156 schrule das', NULL, '2012-10-22 20:42:55', 4),
...
(11, 'Franck', 8, 'Peret', 'Franck', 'franck.perget@gmail.com', 'bd7e1615d796687b51cba7d745544c17', '6', '6154 london park', NULL, '2012-10-22 20:42:55', 6),
(10, 'Gazelle', 8, 'Kolibri', 'Gazelle', 'gazelle.kolibri@gmail.com', '78eab14b3cd1e7d0d4e43faf36cb0512', '8', '561 chinatown', NULL, '2012-10-22 20:42:55', 5),
(3, 'Gérard', 3, 'Hanconinna', 'Gérard', 'gerard.hanconnina@gmail.com', '64d8be661d8a79416eb6662db51e7118', '2', '25 Rue pétain', 126548795, '2012-10-22 20:42:55', NULL),
(4, 'Jean-michel', 1, 'Durand', 'Jean-michel', 'jeanmichel.durand@gmail.com', '0f4acde17f97a0b51868972f992f87e6', '1', '95 Place de l''étoile', 562154987, '2012-10-22 20:42:55', NULL),
...
(5, 'Kévin', 5, 'Kitvikosky', 'Kévin', 'kevin.kitvikosky@gmail.com', '9d5e3ecdeb4cdb7acfd63075ae046672', '5', '653 Main Street', 555365125, '2012-10-22 20:42:55', NULL),
...
(6, 'Marc', 8, 'Simoret', 'Marc', 'marc.simoret@gmail.com', 'f5888d0bb58d611107e11f7cbc41c97a', '5', '154 rue de moncuq', NULL, '2012-10-22 20:42:55', 1),
(7, 'Paul', 8, 'Balouche', 'Paul', 'paul.balouche@gmail.com', 'dd41cb18c930753cbecf993f828603dc', '3', '562 place de la république', NULL, '2012-10-22 20:42:55', 2),
(8, 'Paulo', 8, 'Vergoza', 'Paulo', 'paulo.vergoza@gmail.com', 'dd41cb18c930753cbecf993f828603dc', '10', '153 de la plaza centrale', NULL, '2012-10-22 20:42:55', 3),
...
INSERT INTO `vol` (`id_vol`, `numero_ligne`, `id_aeroport_depart_effectif`, `id_aeroport_arrivee_effectif`, `date_depart`, `date_arrivee`, `id_avion`, `id_pilote`, `id_copilote`, `heure_arrivee_effective`, `tarif_effectif`, `is_arrive`) VALUES
(1, 18, 'CDG', 'MRS', '2012-11-07', '2012-11-08', NULL, NULL, NULL, NULL, '0.00', 0),
(1, 19, 'LYS', 'PEK', '2012-10-09', '2012-10-09', 2, 7, 2, '18:00:00', '5.00', 0),
(2, 19, 'CDG', 'CDG', '2013-01-22', '2013-01-23', NULL, NULL, NULL, NULL, NULL, 0),
(3, 19, 'LYS', 'PEK', '2013-01-31', '2013-01-31', 3, 7, 2, '18:00:00', '5.00', 0),
(1, 25, 'LHR', 'MUC', '2013-01-30', '2013-01-30', 10, 3, 7, '06:00:00', '5.00', 0),
(1, 30, 'LYS', 'CDG', '0000-00-00', '0000-00-00', NULL, NULL, NULL, NULL, '145.00', 0),
(1, 31, 'MRS', 'LYS', '2012-11-26', '2012-11-20', NULL, NULL, NULL, NULL, '0.00', 0),
(1, 33, 'MRS', 'LYS', '2012-11-19', '2012-11-26', NULL, NULL, NULL, NULL, '0.00', 0),
(1, 34, 'MRS', 'CDG', '2012-11-27', '2012-11-28', NULL, NULL, NULL, NULL, '0.00', 0),
(1, 35, 'MRS', 'LYS', '2012-11-14', '2012-11-12', NULL, NULL, NULL, NULL, '0.00', 0),
(1, 36, 'MRS', 'LYS', '2012-11-26', '2012-11-25', NULL, NULL, NULL, NULL, '0.00', 0),
(1, 37, 'MRS', 'LYS', '2012-11-27', '2012-11-28', NULL, NULL, NULL, NULL, '0.00', 0),
(1, 38, 'MRS', 'LYS', '2012-11-14', '2012-11-15', NULL, NULL, NULL, NULL, '0.00', 0),
(1, 39, 'CDG', 'LYS', '2012-11-06', '2012-11-07', NULL, NULL, NULL, NULL, '0.00', 0),
(1, 40, 'CDG', 'CDG', '2012-11-06', '2012-11-06', NULL, NULL, NULL, NULL, '0.00', 0),
(1, 41, 'MRS', 'MRS', '2012-11-07', '2012-11-07', NULL, NULL, NULL, NULL, '0.00', 0),
(1, 44, 'MRS', 'LYS', '2012-11-07', '2012-11-08', NULL, NULL, NULL, NULL, '0.00', 0),
(1, 46, 'MRS', 'LYS', '2013-01-28', '2013-01-28', 6, 11, 5, '21:00:00', '154.00', 0),
(1, 50, 'LYS', 'CDG', '2012-11-12', '2012-11-12', NULL, NULL, NULL, NULL, '0.00', 0),
(1, 51, 'CDG', 'LYS', '2012-11-04', '2012-11-04', NULL, NULL, NULL, NULL, '0.00', 0),
(1, 53, 'PEK', 'MAN', '2012-11-05', '2012-11-05', NULL, NULL, NULL, NULL, '150.00', 0),
(1, 54, 'MRS', 'MRS', '2013-01-29', '2013-01-29', 6, 11, 5, '03:36:20', '456.00', 0),
(1, 59, 'LYS', 'MRS', '2013-01-30', '2013-01-30', 2, 1, 2, '03:38:48', '45.00', 0),
(1, 60, 'CDG', 'MRS', '2012-11-05', '2012-11-14', NULL, NULL, NULL, NULL, '0.00', 0),
(1, 62, 'LYS', 'MRS', '2012-11-13', '2012-11-13', NULL, NULL, NULL, NULL, '5.00', 0),
(1, 63, 'PEK', 'MAN', '2012-11-13', '2012-11-15', 12, NULL, NULL, NULL, '0.00', 0),
(1, 64, 'SXF', 'MAN', '2012-11-01', '2012-11-01', 12, NULL, NULL, NULL, '0.00', 0);
...
ALTER TABLE `remarque`
  ADD CONSTRAINT `remarque_ibfk_3` FOREIGN KEY (`id_client`) REFERENCES `client` (`id_client`),
